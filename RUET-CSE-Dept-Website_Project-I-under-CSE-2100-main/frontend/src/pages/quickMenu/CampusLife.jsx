...
import { campusLifeItems } from "../../constants/campusLifeData"
...
const CampusLife = () => {
  ...
  const filteredItems = useMemo(() => {
    return campusLifeItems.filter(item => {
      if (appliedSearch) {
  ...
  return (
    <>
      <Breadcrumb current="Campus Life" />
      <PageHeroBanner title="Campus Life" navLinks={SUB_NAV} activeTo="/campus-life" />
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex justify-between font-semibold bg-blue font-inter">
            <p className="text-white px-5 py-2" style={{ fontSize: 'clamp(0.9rem, 1.2vw, 1.125rem)' }}>Campus Life</p>
